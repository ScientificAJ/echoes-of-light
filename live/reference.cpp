...
constexpr double rout=38.; double incl=75*pi/180.;
...
int main(){double x,y,degrees;while(scanf("%lf %lf %lf",&x,&y,&degrees)==3){incl=degrees*pi/180.;float o[8]={};trace(x,y,.125,o);for(float v:o)printf("%.10g ",v);printf("\n");fflush(stdout);}return 0;}
